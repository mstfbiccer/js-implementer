(function () {
        ...
        this.normalizeRules = function () {
            function i(s) {
                ...
                for (var u = 0; u < o.length; u++) {
                    ...
                    if (a.rules)
                        for (var h in a.rules) r[h] ? r[h].push && r[h].push.apply(r[h], a.rules[h]) : r[h] = a.rules[h];
                ...
                if (i == '"' || i == "'") {
                    ...
                    if (!u) {
                        ...
                        var m = d && /string|escape/.test(d.type),
                            ...
                            y;
                        if (p == s) y = m !== g, y && /string\.end/.test(v.type) && (y = !1);
                        else {
                            if (m && !g) return null;
                            if (m && g) return null;
    ...
    (function () {
        this.$behaviour = new s, this.tokenRe = new RegExp("^[" + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + "\\$_]|\\s])+", "g"), this.getTokenizer = function () {
    ...
    }, t.EditSession = o, t.UndoManager = u, t.version = "1.2.4"
});
(function () {
